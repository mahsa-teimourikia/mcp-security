...
9. [Runtime security, observability, and continuous assurance](11-runtime-assurance-and-observability.md) · [runtime policy lab](../legacy-labs/intermediate/03_runtime_policy.py) · [containment runbook](../legacy-labs/advanced/03_containment_runbook.py) · [notebook](../legacy-labs/notebooks/03_runtime_assurance.ipynb)
...
Run `python3 curriculum/shared/legacy-labs/capstone_secure_server.py`, inspect `tests/adversarial_cases.json`, and complete the operator checklist before calling the course complete.
